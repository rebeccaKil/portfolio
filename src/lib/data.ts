...
export const ABOUT = {
  intro: [
    ...
    "생성형 AI로 기획을 구현까지 직접 연결합니다. 내부 서비스 DB와 GA를 MCP로 직접 연동해 데이터를 즉시 확인하고, Jira·Gmail 자동화로 업무 현황을 Confluence에 적재합니다. Slack 봇, Vercel 배포, Supabase PostgreSQL DB 구축까지 — Cursor·Claude Code·Codex로 혼자 완결합니다.",
  ],
  highlights: [
    ...
    { icon: "⬛", label: "기획-코드-배포 직접 연결", desc: "DB·GA MCP 직접 연동, Jira·Gmail 자동화, Slack 봇, Vercel 배포까지 — Cursor·Claude Code로 혼자 완결." },
  ],
  validation: {
    grade: "A+",
